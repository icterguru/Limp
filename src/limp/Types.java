...
public class Types {
    ...
    public static final String GETCHR = "getchr";
    public static final String STRIM = "strim";
    public static final String TOINT = "int"; // convert string to int
    public static final String TOSTRING = "str"; // convert int/string to string
